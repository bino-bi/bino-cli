...
If a referenced document is not found (e.g., filtered out by constraints or simply doesn't exist), the child is silently skipped and a warning is logged. This allows constraint-based filtering to work naturally with referenced components.
