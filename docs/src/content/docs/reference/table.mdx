...
| `spec.i18nNamespace` | string | no | — | I18n namespace for this component's labels; missing keys fall back to `_system`. Inherited from the enclosing artefact/page/card/grid/tree when not set. Maps to the `namespace` HTML attribute. | `i18nNamespace: audited` |
