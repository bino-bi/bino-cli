...
spec:
  ...
  sumTitle: "Total"                  # label of the grand-total row; only rendered for type sum | opt
  ...
  unitScaling: 100                   # data units per em of bar (absolute variance bars)
  percentageScaling: 2               # percentage points per em of pin (relative variance pins)
  thereof: []
  partof: []
  columnthereof: null
