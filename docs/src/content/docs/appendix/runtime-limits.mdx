...
| :------------------------------ | :------ | :--------------------------------------------------- |
| `BNR_DATA_VALIDATION_SAMPLE_SIZE` | `10`    | Number of rows to validate per dataset               |
...
See [bino build](/cli/build/#data-validation) for more information on data validation modes.
