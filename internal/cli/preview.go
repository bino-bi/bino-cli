		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			go func() {
				...
				server.SetEmbeddingFunc(func(ctx context.Context, name, kind string) ([]byte, error) {
					return embedByName(ctx, name, kind, refreshMu, refreshState, &refreshCfg, server)
				})
...
func embedComponentOpts(cfg *previewRefreshConfig, name string) pipeline.RenderOptions {
...
func embedRenderOpts(cfg *previewRefreshConfig) pipeline.RenderArtefactOptions {
...
func embeddableNames(state *previewRefreshState) []string {
