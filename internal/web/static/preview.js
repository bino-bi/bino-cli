...
`),o.addEventListener("click",function(m){m.stopPropagation(),t._visible=!0,t._highlightForElement(i)});var c=i.parentNode;if(c){var h=window.getComputedStyle(c);h.position==="static"&&(c.style.position="relative"),i.insertAdjacentElement("afterend",o)}t._badges.push(o)})}_removeBadges(){this._badges.forEach(function(e){e.parentNode&&e.parentNode.removeChild(e)}),this._badges=[]}};customElements.define("bino-error-panel",Ce);var Oe=class extends z{static properties={_results:{state:!0},_activeIndex:{state:!0},_open:{state:!0}};static styles=L`
    :host {
      position: relative;
  ...
  `;constructor(){super(),this._documents=[],this._open=!1,this._selectedDoc=null,this._filterKind="",this._boundOnOpen=this._onOpen.bind(this),this._boundOnChanged=this._onChanged.bind(this),this._boundOnKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("bino-open-assets",this._boundOnOpen),document.addEventListener("bino-documents-changed",this._boundOnChanged),document.addEventListener("keydown",this._boundOnKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("bino-open-assets",this._boundOnOpen),document.removeEventListener("bino-documents-changed",this._boundOnChanged),document.removeEventListener("keydown",this._boundOnKeydown)}render(){if(!this._open)return C;var e=this,t=this._filteredDocs(),r=this._uniqueKinds();return b`
    ...
    `}_filteredDocs(){if(!this._filterKind)return this._documents;var e=this._filterKind;return this._documents.filter(function(t){return t.kind===e})}_uniqueKinds(){var e={},t=[];return this._documents.forEach(function(r){e[r.kind]||(e[r.kind]=!0,t.push(r.kind))}),t}_countKind(e){var t=0;return this._documents.forEach(function(r){r.kind===e&&t++}),t}_onOpen(e){this._documents=e.detail&&e.detail.documents||[],this._open=!0,this._selectedDoc=null,this._filterKind=""}_onChanged(e){if(this._open&&(this._documents=e.detail&&e.detail.documents||[],this._selectedDoc)){var t=this._selectedDoc,r=this._documents.some(function(n){return n.kind===t.kind&&n.name===t.name&&n.file===t.file});r||(this._selectedDoc=null)}}_onKeydown(e){this._open&&e.key==="Escape"&&this._close()}_onBackdropClick(){this._close()}_stopPropagation(e){e.stopPropagation()}_close(){this._open=!1,this._selectedDoc=null}};customElements.define("bino-assets-modal",ze);var B=170,te=38,Le=20,Ct=56,le=30,Ot={ReportArtefact:{bg:"#d4f7f9",stroke:"#0b727e",text:"#0c454c"},DocumentArtefact:{bg:"#d4f7f9",stroke:"#0b727e",text:"#0c454c"},LayoutPage:{bg:"#d6ecdd",stroke:"#1f7a3d",text:"#1f7a3d"},LayoutCard:{bg:"#ecfcfd",stroke:"#5cdae5",text:"#0c5a64"},Component:{bg:"#f7aace",stroke:"#e23e8c",text:"#c11f6e"},DataSet:{bg:"#fff0a8",stroke:"#d99e0b",text:"#1f262a"},DataSource:{bg:"#f6ddda",stroke:"#c0392b",text:"#c0392b"},MarkdownFile:{bg:"#eef2f3",stroke:"#9aa7ad",text:"#333c41"}},zt={ReportArtefact:"Artefact",DocumentArtefact:"DocArtefact",LayoutPage:"Page",LayoutCard:"Card",Component:"Component",DataSet:"DataSet",DataSource:"Source",MarkdownFile:"Markdown"};function dt(s){return Ot[s]||{bg:"#eef2f3",stroke:"#9aa7ad",text:"#333c41"}}function Lt(s){return zt[s]||s}function Mt(s,e){return e||(e=20),!s||s.length<=e?s||"":s.substring(0,e-1)+"\u2026"}function Tt(s){if(!s||!s.rootId)return null;var e=s.nodes||{},t={},r={};function n(i){if(!i)return null;var o=e[i];if(!o)return null;if(t[i])return{id:i,kind:o.kind,name:o.name||i,children:[],cycle:!0};if(r[i])return{id:i,kind:o.kind,name:o.name||i,children:[],ref:!0};t[i]=!0,r[i]=!0;for(var c=[],h=o.dependsOn||[],m=0;m<h.length;m++){var $=n(h[m]);$&&c.push($)}return t[i]=!1,{id:i,kind:o.kind,name:o.name||i,children:c}}return n(s.rootId)}function ct(s){if(!s)return 0;if(s.children.length===0)return s.w=B,B;for(var e=0,t=0;t<s.children.length;t++)e+=ct(s.children[t]);return e+=(s.children.length-1)*Le,s.w=Math.max(e,B),s.w}function Rt(s){if(!s)return{nodes:[],edges:[],width:0,height:0};ct(s);var e=[],t=[],r=0,n=0;function i(o,c,h){if(o){var m=c-B/2;if(e.push({id:o.id,kind:o.kind,name:o.name,x:m,y:h,cx:c,ref:o.ref||!1,cycle:o.cycle||!1}),c+B/2>r&&(r=c+B/2),h+te>n&&(n=h+te),o.children.length!==0){for(var $=h+te+Ct,E=0,f=0;f<o.children.length;f++)E+=o.children[f].w;E+=(o.children.length-1)*Le;for(var w=c-E/2,f=0;f<o.children.length;f++){var g=o.children[f],S=w+g.w/2;t.push({x1:c,y1:h+te,x2:S,y2:$}),i(g,S,$),w+=g.w+Le}}}}return i(s,s.w/2+le,le),{nodes:e,edges:t,width:r+le,height:n+le}}var Me=class extends z{static properties={_graphData:{state:!0},_open:{state:!0}};static styles=L`
  ...
  `;constructor(){super(),this._graphData=null,this._open=!1,this._boundOnOpen=this._onOpen.bind(this),this._boundOnKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("bino-open-graph",this._boundOnOpen),document.addEventListener("keydown",this._boundOnKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("bino-open-graph",this._boundOnOpen),document.removeEventListener("keydown",this._boundOnKeydown)}render(){if(!this._open)return C;var e=Tt(this._graphData),t=Rt(e);return b`
    ...
    `}_renderSVG(e){if(!e||e.nodes.length===0)return b`<div class='empty'>No graph data available</div>`;var t=e.width,r=e.height,n=e.edges.map(function(o){var c=(o.y1+o.y2)/2;return Ee`<path d=${"M"+o.x1+","+o.y1+" C"+o.x1+","+c+" "+o.x2+","+c+" "+o.x2+","+o.y2}
        fill='none' stroke='#cbd4d8' stroke-width='1.5'/>`}),i=e.nodes.map(function(o){var c=dt(o.kind),h=o.ref||o.cycle?"0.5":"1",m=Lt(o.kind),$=Mt(o.name),E=o.cycle?" [cycle]":o.ref?" [ref]":"";return Ee`
        <g opacity=${h}>
    ...
    `}_renderLegend(e){if(!e||e.nodes.length===0)return C;var t={},r=[];return e.nodes.forEach(function(n){t[n.kind]||(t[n.kind]=!0,r.push(n.kind))}),r.length===0?C:b`
      <div class='legend'>
        ${r.map(function(n){var i=dt(n);return b`
    ...
    `}_onOpen(e){this._graphData=e.detail&&e.detail.graph||null,this._open=!0}_onKeydown(e){this._open&&e.key==="Escape"&&this._close()}_close(){this._open=!1}_stop(e){e.stopPropagation()}};customElements.define("bino-graph-modal",Me);var Dt=[25,50,100,250],ht=20,ut="bino-explorer-layout",de="bino-explorer-sql",Te="bino-explorer-history",ce=180,he=560,re=64,Nt=140;function K(s,e,t){return Math.min(Math.max(s,e),t)}function ne(s,e){try{var t=window.localStorage.getItem(s);return t!=null?JSON.parse(t):e}catch{return e}}function ue(s,e){try{window.localStorage.setItem(s,JSON.stringify(e))}catch{}}var Re=class extends z{static properties={_open:{state:!0},_metadata:{state:!0},_sql:{state:!0},_result:{state:!0},_summarizeResult:{state:!0},_loading:{state:!0},_error:{state:!0},_page:{state:!0},_pageSize:{state:!0},_activeTab:{state:!0},_expandedSource:{state:!0},_refreshing:{state:!0},_sidebarWidth:{state:!0},_editorHeight:{state:!0},_dragging:{state:!0},_history:{state:!0},_historyOpen:{state:!0},_exporting:{state:!0}};static styles=L`
    :host {
      font-family: var(--bino-font-sans);
    }
    .backdrop {
  ...
  `;constructor(){super(),this._open=!1,this._metadata=null,this._sql=typeof ne(de,"")=="string"?ne(de,""):"",this._result=null,this._summarizeResult=null,this._loading=!1,this._error="",this._page=0,this._pageSize=50,this._activeTab="results",this._expandedSource=null,this._refreshing=!1;var e=ne(ut,{});this._sidebarWidth=K(Number(e.sidebarWidth)||280,ce,he),this._editorHeight=Math.max(Number(e.editorHeight)||160,re),this._dragging=!1,this._history=Array.isArray(ne(Te,[]))?ne(Te,[]):[],this._historyOpen=!1,this._exporting=!1,this._boundOnOpen=this._onOpen.bind(this),this._boundOnKeydown=this._onKeydown.bind(this),this._boundOnDocsChanged=this._onDocsChanged.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("bino-open-explorer",this._boundOnOpen),document.addEventListener("keydown",this._boundOnKeydown),document.addEventListener("bino-documents-changed",this._boundOnDocsChanged)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("bino-open-explorer",this._boundOnOpen),document.removeEventListener("keydown",this._boundOnKeydown),document.removeEventListener("bino-documents-changed",this._boundOnDocsChanged)}render(){return this._open?b`
                ...
                <div>
                  ...
                  ${i&&n.columns&&n.columns.length>0?b`
                    <div class="column-list">
                      ${n.columns.map(function(o){return b`
    ...
    `:b`<div class="history-menu"><div class="history-empty">No queries yet</div></div>`}_renderResults(){if(this._loading)return b`<div class="loading-msg">Executing query...</div>`;if(this._error)return b`<div class="error-msg">${this._error}</div>`;if(!this._result)return b`<div class="empty-state">Run a query to see results</div>`;if(this._result.error)return b`
      ...
      `;var e=this,t=this._result.columns||[],r=this._result.rows||[],n=this._result.totalRows,i=typeof n=="number"?Math.ceil(n/this._pageSize):null,o=this._page*this._pageSize;return b`
      ...
      <div class="pagination">
        ...
        <select .value=${String(this._pageSize)} @change=${function(c){e._pageSize=parseInt(c.target.value,10),e._page=0,e._rerunQuery()}}>
          ${Dt.map(function(c){return b`<option value=${c} ?selected=${c===e._pageSize}>${c} rows</option>`})}
        </select>
    ...
    `}_onOpen(){this._open=!0,this._fetchMetadata()}_close(){this._open=!1,this._historyOpen=!1}_onKeydown(e){if(this._open&&e.key==="Escape"){if(this._historyOpen){this._historyOpen=!1;return}this._close()}}_onExplorerClick(){this._historyOpen&&(this._historyOpen=!1)}_onDocsChanged(){this._open&&this._fetchMetadata()}_onRefresh(){if(!this._refreshing){this._refreshing=!0;var e=this;this._fetchMetadata(function(){e._refreshing=!1})}}_onSqlInput(e){this._sql=e.target.value,ue(de,this._sql)}_setSql(e){this._sql=e,ue(de,e)}_maxEditorHeight(){var e=this.renderRoot.querySelector(".main-panel");return e?Math.max(e.clientHeight-Nt,re):600}_startEditorDrag(e){e.preventDefault();var t=this,r=e.clientY,n=this._editorHeight,i=this._maxEditorHeight();this._dragging="editor";function o(h){t._editorHeight=K(n+(h.clientY-r),re,i)}function c(){window.removeEventListener("pointermove",o),window.removeEventListener("pointerup",c),t._dragging=!1,t._saveLayout()}window.addEventListener("pointermove",o),window.addEventListener("pointerup",c)}_startSidebarDrag(e){e.preventDefault();var t=this,r=e.clientX,n=this._sidebarWidth;this._dragging="sidebar";function i(c){t._sidebarWidth=K(n+(c.clientX-r),ce,he)}function o(){window.removeEventListener("pointermove",i),window.removeEventListener("pointerup",o),t._dragging=!1,t._saveLayout()}window.addEventListener("pointermove",i),window.addEventListener("pointerup",o)}_onEditorSplitterKey(e){var t=16;e.key==="ArrowUp"?(e.preventDefault(),this._editorHeight=K(this._editorHeight-t,re,this._maxEditorHeight()),this._saveLayout()):e.key==="ArrowDown"&&(e.preventDefault(),this._editorHeight=K(this._editorHeight+t,re,this._maxEditorHeight()),this._saveLayout())}_onSidebarSplitterKey(e){var t=16;e.key==="ArrowLeft"?(e.preventDefault(),this._sidebarWidth=K(this._sidebarWidth-t,ce,he),this._saveLayout()):e.key==="ArrowRight"&&(e.preventDefault(),this._sidebarWidth=K(this._sidebarWidth+t,ce,he),this._saveLayout())}_saveLayout(){ue(ut,{sidebarWidth:this._sidebarWidth,editorHeight:this._editorHeight})}_recordHistory(e){var t={sql:e,ts:Date.now()},r=this._history.filter(function(n){return n.sql!==e});r.unshift(t),r.length>ht&&(r.length=ht),this._history=r,ue(Te,r)}_applyHistoryEntry(e){this._setSql(e.sql),this._historyOpen=!1,this._page=0,this._runQuery()}_formatHistoryTime(e){if(!e)return"";var t=new Date(e),r=new Date,n=t.toDateString()===r.toDateString();return n?t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):t.toLocaleDateString([],{month:"short",day:"numeric"})}_onEditorKeydown(e){if(e.key==="Tab"){e.preventDefault();var t=e.target,r=t.selectionStart,n=t.selectionEnd;this._setSql(this._sql.substring(0,r)+"  "+this._sql.substring(n)),this.updateComplete.then(function(){t.selectionStart=t.selectionEnd=r+2});return}e.key==="Enter"&&(e.metaKey||e.ctrlKey)&&(e.preventDefault(),this._runQuery())}_selectSource(e){this._setSql('SELECT * FROM "'+e+'"'),this._page=0,this._activeTab="results",this._runQuery()}_selectDataset(e){e&&e.sql?this._setSql(e.sql):e&&e.sqlError?this._setSql('-- Cannot resolve SQL for dataset "'+e.name+`":
-- `+e.sqlError):this._setSql('-- Dataset "'+(e&&e.name)+'" has no resolvable SQL.'),this._page=0,this._activeTab="results",e&&e.sql&&this._runQuery()}_toggleSourceInfo(e){this._expandedSource=this._expandedSource===e?null:e}_clearEditor(){this._setSql(""),this._result=null,this._summarizeResult=null,this._error="",this._page=0}_rerunQuery(){this._sql.trim()&&this._runQuery()}_runQuery(){var e=this._sql.trim();if(e){var t=this;this._loading=!0,this._error="",this._activeTab="results",this._recordHistory(e),fetch(M()+"/__explorer/query",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sql:e,limit:this._pageSize,offset:this._page*this._pageSize})}).then(function(r){return r.json()}).then(function(r){t._result=r,t._loading=!1}).catch(function(r){t._error=r.message||"Query failed",t._loading=!1})}}_runSummarize(){var e=this._sql.trim();if(e){var t=this;this._loading=!0,this._error="",this._activeTab="summarize",fetch(M()+"/__explorer/summarize",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sql:e})}).then(function(r){return r.json()}).then(function(r){t._summarizeResult=r,t._loading=!1}).catch(function(r){t._error=r.message||"Summarize failed",t._loading=!1})}}_exportCSV(){var e=this._sql.trim();if(!(!e||this._exporting)){var t=this;this._exporting=!0,fetch(M()+"/__explorer/export",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sql:e})}).then(function(r){var n=r.headers.get("Content-Type")||"";return n.indexOf("text/csv")===-1?r.json().then(function(i){throw new Error(i.error||"Export failed")}):r.blob()}).then(function(r){var n=URL.createObjectURL(r),i=document.createElement("a");i.href=n,i.download="bino-explorer-export.csv",i.click(),URL.revokeObjectURL(n),t._exporting=!1}).catch(function(r){t._error=r.message||"Export failed",t._activeTab="results",t._exporting=!1})}}_fetchMetadata(e){var t=this;fetch(M()+"/__explorer/metadata").then(function(r){return r.json()}).then(function(r){t._metadata=r,e&&e()}).catch(function(r){console.error("explorer: fetch metadata failed",r),e&&e()})}};customElements.define("bino-data-explorer",Re);if(!(!window.EventSource||window.__bnPreviewRuntime)){let s=function(){Ne&&He&&e("initial")},e=function(r){var n=++Pe;fetch(De+"/__preview/context?path="+encodeURIComponent(N)).then(function(i){return i.ok?i.text():(console.warn("bn preview: context fetch failed",i.status,r),null)}).then(function(i){if(!(!i||n!==Pe)){var o=Ve(i,pt);if(o){qe=!0;try{document.dispatchEvent(new CustomEvent("bn-preview:content-updated",{detail:{path:N}}))}catch(c){console.debug("bn preview: custom event skipped",c)}}else console.warn("bn preview: swapContext returned false; DOM not updated")}}).catch(function(i){console.error("bn preview: context fetch errored",i)})},t=function(){if(N==="/"){document.querySelectorAll(".bn-page-info").forEach(function(m){m.remove()});var r=document.querySelector("bn-context");if(r){var n=r.getAttribute("data-page-meta");if(n){var i;try{i=JSON.parse(n)}catch{return}if(Array.isArray(i)){var o={};i.forEach(function(m){o[m.name]=m});var c=r.shadowRoot||r,h=c.querySelectorAll("bn-layout-page[data-bino-page]");h.length===0&&(h=document.querySelectorAll("bn-layout-page[data-bino-page]")),h.forEach(function(m){var $=m.getAttribute("data-bino-page");if($){var E=$.split("#")[0],f=o[E]||o[$];if(f){var w=document.createElement("div");w.className="bn-page-info";var g=document.createElement("span");if(g.className="bn-page-info-name",g.textContent=$,w.appendChild(g),f.constraints&&f.constraints.length>0){var S=document.createElement("span");S.className="bn-page-info-label",S.textContent="constraints:",w.appendChild(S),f.constraints.forEach(function(y){var d=document.createElement("span");d.className="bn-page-info-pill constraint",d.textContent=y,w.appendChild(d)})}if(f.artifacts&&f.artifacts.length>0){var k=document.createElement("span");k.className="bn-page-info-label",k.textContent="used in:",w.appendChild(k),f.artifacts.forEach(function(y){var d=document.createElement("span");d.className="bn-page-info-pill artefact",d.textContent=y,w.appendChild(d)})}m.parentNode.insertBefore(w,m)}}})}}}}};window.__bnPreviewRuntime=!0,console.info("bn preview runtime v11 (proxy base-prefix aware)"),pt=new DOMParser,De=M(),N=Be(),V=new EventSource(De+"/__preview/events"),Ne=!1,He=!1,Ke().then(function(){He=!0,s()}),V.addEventListener("ready",function(){Ne=!0,document.dispatchEvent(new CustomEvent("bn-preview:refresh-done")),s()}),V.addEventListener("refreshing",function(r){try{var n=JSON.parse(r.data||"{}");document.dispatchEvent(new CustomEvent("bn-preview:refreshing",{detail:n}))}catch{document.dispatchEvent(new CustomEvent("bn-preview:refreshing",{detail:{}}))}}),V.addEventListener("refresh-done",function(r){var n={};try{n=JSON.parse(r.data||"{}")||{}}catch{n={}}var i=Array.isArray(n.paths)?n.paths:[],o=!1;if(i.length>0){for(var c=0;c<i.length;c++)if(F(i[c])===N){o=!0;break}o||(console.warn("bn preview: refresh did not include this view",N,"broadcast paths:",i),document.dispatchEvent(new CustomEvent("bn-preview:no-payload",{detail:{path:N,broadcastPaths:i}})))}o&&!qe&&e("initial-retry"),document.dispatchEvent(new CustomEvent("bn-preview:refresh-done",{detail:n}))}),Pe=0,qe=!1,V.addEventListener("path-changed",function(r){var n={};try{n=JSON.parse(r.data||"{}")||{}}catch{return}!n.path||F(n.path)!==N||e("path-changed")}),V.addEventListener("refresh-error",function(r){var n={};try{n=JSON.parse(r.data||"{}")}catch{}n&&n.path&&F(n.path)!==N||(console.error("bn preview: refresh failed",n&&n.message),document.dispatchEvent(new CustomEvent("bn-preview:refresh-error",{detail:n})))}),window.addEventListener("beforeunload",function(){V.close()}),document.addEventListener("click",function(r){if(!(!r.metaKey&&!r.ctrlKey)){var n=r.target.closest("[data-bino-kind]");if(n){var i={type:"bino:revealSource",kind:n.getAttribute("data-bino-kind"),name:n.getAttribute("data-bino-name")||"",ref:n.getAttribute("data-bino-ref")||""};window.parent&&window.parent!==window&&window.parent.postMessage(i,"*"),r.preventDefault(),r.stopPropagation()}}}),document.addEventListener("bn-preview:content-updated",function(){t()}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()}var pt,De,N,V,Ne,He,Pe,qe;
