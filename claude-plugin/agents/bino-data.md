...
model: opus
color: blue
tools: Read, Write, mcp__bino__introspect_source, mcp__bino__get_columns, mcp__bino__get_rows, mcp__bino__describe_kind, mcp__bino__describe_project, mcp__bino__describe_document, mcp__bino__list_kinds, mcp__bino__graph_deps, mcp__bino__validate_draft, mcp__bino__create_manifest, mcp__bino__write_manifest, mcp__bino__edit_manifest, mcp__bino__scaffold_source, mcp__bino__validate_project
---
